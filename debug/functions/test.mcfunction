...
execute as @a[team=undefined] at @s run kill @e[type=undefined,distance=undefined,nbt=undefined]
scoreboard players reset @a[tag=undefined,scores=undefined] GCAR.long
## WARNING: The transformation may cause problem. You might need to modify it by yourself.
data modify entity @e[limit=undefined,type=undefined,tag=undefined] Item.components."minecraft:bundle_contents" set from entity @s Inventory
